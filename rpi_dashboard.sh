#!/usr/bin/env bash
### Created by Peter Forret ( pforret ) on 2022-11-01
### Based on https://github.com/pforret/bashew 1.19.2
### Inspiration: https://clevertap.com/blog/using-raspberry-pi-to-build-a-commercial-grade-wall-information-dashboard/?utm_source=pocket_mylist
script_version="0.0.1" # if there is a VERSION.md in this script's folder, it will take priority for version number
readonly script_author="peter@forret.com"
readonly script_created="2022-11-01"
...
Option:usage() {
  ...
  IO:print "Purpose : ${txtInfo}Dahsboard with rotating pages on Raspberry Pi${txtReset}"
